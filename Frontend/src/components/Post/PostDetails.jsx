...
const PostDetails = () => {
  ...
  const creator = post?.data?.author?._id?.toString();
    ...
    <>
      {error ? (
        ...
        <section className="py-16 bg-white md:py-24">
              ...
              <div className="flex items-center justify-center -mx-2 text-left">
                <div className="w-auto px-2">
                  <img
                    ...
                    src={post?.data?.author?.profilePicture}
                    alt="Profile"
                  />
                </div>
                <div className="w-auto px-2">
                  ...
                  <p className="text-base md:text-lg text-coolGray-500">
                    {getDate(post?.data?.author?.createdAt)}
                  </p>
                </div>
              </div>
            </div>
          ...
          <img
            className="w-4xl px-4 mx-auto mb-10"
            src={post?.data?.image}
            alt="Post"
          />
          ...
          <div className="flex justify-center items-center h-full">
            <PostStats
              postId={postId}
              views={post?.data?.postViews.length}
          ...
          <div className="container px-4 mx-auto">
            <div className="mx-auto md:max-w-3xl">
              ...
              <div className="flex justify-end mb-4">
                {isCreator && (
                  <>
                    ...
                    <Link
                      to={`/posts/${post?.data?._id}/update-post`}
              ...
              <AddComment
                postId={postId}
                comments={post?.data?.comments || []} // ✅ safe fallback
              />
            </div>
          </div>
        </section>
